...
local MrMacro = {
    ...
    primaryKey = "macroId",
    apiForName = C_Macro.GetMacroName, -- maybe GetMacroInfo
    --apiForIcon = C_Macro.GetSelectedMacroIcon, -- replaced by getIcon() below
    apiForPickup = PickupMacro,
    --apiForToolTip = ????, -- replaced by getToolTipSetter() below
