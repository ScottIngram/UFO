...
---@field myBlizUiId any generated by Bliz API when you give it the config panel def
...
function Config:initializeOptionsMenu()
    ...
    LibStub("AceConfigDialog-3.0.UFO"):AddToBlizOptions(ADDON_NAME, Ufo.myTitle)
end

function Config:open()
    Settings.OpenToCategory(Ufo.configUiId, Ufo.myTitle)
end
