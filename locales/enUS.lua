...
SLASH_CMD_SNAPSHOT_SAVE = "save"
SLASH_DESC_SNAPSHOT_SAVE = "save a snapshot of UFO locations on the actionbars."
SLASH_CMD_SNAPSHOT_LOAD = "load"
SLASH_DESC_SNAPSHOT_LOAD = "load the previously saved actionbar snapshot."
...
SAVED_SNAPSHOT = "Saved a snapshot."
LOADED_SNAPSHOT = "Snapshot loaded."
...
SNAPSHOT = "Snapshot"
SNAPSHOT_HELP = "You can take a snapshot of UFO locations on the actionbars and then reload it later for the current toon or any alt.  This is also usable via /ufo save or /ufo load"
SNAPSHOT_SAVE_BTN = "Save Snapshot"
SNAPSHOT_SAVE_HELP = "Store a copy of the current positions of the UFOs on the action bars."
SNAPSHOT_LOAD_BTN = "Load Snapshot"
SNAPSHOT_LOAD_HELP = "Store a copy of the current positions of the UFOs on the action bars"
SNAPSHOT_UNDO_BTN = "Undo Load"
